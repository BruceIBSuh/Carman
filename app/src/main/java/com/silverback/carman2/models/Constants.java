...
public class Constants {
     ...
     */
    public static final String MIN_RADIUS = "100"; //Current station locating radius
    ...
    public static final String FILE_CACHED_STATION_AROUND = "tmpStnList";
    ...
    public static final String DISTRICT = "carman_pref_spinner_dialog_district";
