...
public class StatGraphView extends LinearLayout {
    ...
    private void init() {
        ...
        log.i("init() in StatGraphView");

        int smallTextSize = getResources().getDimensionPixelSize(R.dimen.smallTextSize);
